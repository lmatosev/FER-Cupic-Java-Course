...
public class RayCasterParallel {
	 ...
	 *
	 */
	public static class ThreadJob extends RecursiveAction {
		...
		protected void compute() {
			...
			ThreadJob job1 = new ThreadJob(eye, horizontal, vertical, width, height, red, green, blue, xAxis, yAxis,
					zAxis, screenCorner, scene, xMin + (xMax - xMin) / 2, xMax);
			ThreadJob job2 = new ThreadJob(eye, horizontal, vertical, width, height, red, green, blue, xAxis, yAxis,
					zAxis, screenCorner, scene, xMin, xMax - (xMax - xMin) / 2);
			invokeAll(job1, job2);
		}

		/**
		 * {@inheritDoc}
		 * Directly computes part of the whole image.
		 */
